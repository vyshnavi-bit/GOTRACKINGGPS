...
Cluster.prototype.remove = function () {
    if (this.markers_ != null && this.markers_ != undefined) {
...
function ClusterIcon(cluster, styles, opt_padding) {
  cluster.getMarkerClusterer().extend(ClusterIcon, google.maps.OverlayView);
	...
	this.sums_ = null;
	this.visible_ = false;
	// add by GZ on 10/27/10
	//this.infowindow_ = new google.maps.InfoWindow();              
	//this.infowindow_  = new InfoBox(); 
    //this.boxText = document.createElement("div");
	//this.boxText.style.cssText = "border: 1px solid black; margin-top: 8px; background: yellow; padding: 5px; overflow: auto; height: 50px ";
    //this.myOptions = "";
...
boxText.style.cssText = "color: black; border: 1px solid #000000; margin-top: 8px; background:#ffffff; padding: 5px;  overflow: auto; height: 70px ";
boxText.id = "windowdiv";
var myOptions = "";

ClusterIcon.prototype.triggerClusterOver = function () {
    foo = ""
    for (i = 0; i < this.cluster_.markers_.length; i++) {
        //	    foo = foo + this.cluster_.markers_[i].title + " " + this.cluster_.markers_[i].position + "<br>";				
        foo = foo + this.cluster_.markers_[i].title + "<br>";
    }

    boxText.innerHTML = foo;
    ...
    myOptions = {
        content: boxText
				...
				, closeBoxMargin: "10px 5px 0px 0px"
    ...
    if (infowindow != null && infowindow.getContent() != foo) {
        infowindow.close();
    }

    else if (infowindow == null) {
        infowindow = new InfoBox();
        google.maps.event.addDomListener(infowindow, 'closeclick', function (evt) { this.setContent(''); });
    }

    if (infowindow.getContent() != foo) {
...
ClusterIcon.prototype.onAdd = function () {
    ...
    // GZ add on 10/27/10 set up a MOUSEOVER and MOUSEOUT listener events
    google.maps.event.addDomListener(this.div_, 'mouseover', function () {
        that.triggerClusterOver();
    });
    //    // GZ add on 10/27/10 set up a MOUSEOVER and MOUSEOUT listener events
...
MarkerClusterer.prototype['getSize'] = MarkerClusterer.prototype.getSize;
